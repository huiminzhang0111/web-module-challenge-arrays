...
function removeLastFlavor(flavors, oldflavor){
 flavors.pop();
 return flavors
}
...
function getFlavorByIndex(flavor, number){
...
function removeFlavorByName(flavor, toberemoved){
  let index = flavor.indexOf(toberemoved);
  if(index > -1){
